/*
 * clSprachenDialog.java
 *
 * Created on 6. December 2003, 22:06
 */
 ...
 */
public class clStringDialog extends javax.swing.JDialog {
    ...
    public clStringDialog(java.awt.Frame parent, String text, String titel, int länge, Locale lc) {        
        super(parent, titel, true);
        einleitung = text;
        Feldlänge = länge; assert länge > 1;
        locale = lc;
