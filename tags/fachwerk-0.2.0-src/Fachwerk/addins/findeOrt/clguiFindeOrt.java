 ...
 */
public class clguiFindeOrt extends javax.swing.JDialog implements inKonstante {
    ...
    clKnoten[] Knotenarray;
    clStab[] Stabarray;
    int[][] Topologie;
    Locale locale;
    Fachwerk.treillis parentfw;
    ...
    private String dxstr, dzstr, xstr, zstr, Fstr, nrstr;
    private double dx, dz, x, z, F;
    private double[] vektor = new double[2];;
    
    /** Creates new form clKnotenDialog */
    public clguiFindeOrt(int p_nr, LinkedList knliste, LinkedList stliste, 
                         Fachwerk.treillis parent, Locale lc) {
        ...
        initComponents();
        felddx.setText(dxstr); felddz.setText(dzstr);
        übersetzen();
        pack(); 
        zentriere(parent);
        show();        
    ...
    private void iterationStarten() {
        ...
        clFindeOrt fo = new clFindeOrt(kn, vektor, stab, F,
    ...
    */
    ...
    private void datenaufbereiten() {
        //Datenaufbereiten
        Knotenarray = new clKnoten[Knotenliste.size() + 1];
        ...
        clWissenderStab wst = (clWissenderStab) Stabliste.get(stabnr-1); // ÜBERPRÜFEN OB -1
        stab = wst.stab;
    }
    ...
    public boolean einlesen() {
        try {
            ...
            stabnr = Fkt.holInt(feldStabnr.getText());
