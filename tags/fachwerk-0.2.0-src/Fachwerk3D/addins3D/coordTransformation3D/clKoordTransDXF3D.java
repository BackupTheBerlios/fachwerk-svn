...
import Fachwerk3D.gui3D.clDXF3D;
import java.util.*;
 ...
 * @author  A.Vontobel
 */
public class clKoordTransDXF3D {
    ...
    public clKoordTransDXF3D(clDXF3D dxf, java.awt.Frame parent, Locale lc) {
        this.dxf = dxf;
        locale = lc;
    ...
    private void transformieren() {
        ...
        dxf.verschiebe(transformation[1], transformation[2], transformation[3]);        
    }
